...
- Optional: Install `graphql_client_cli` for GraphQL schema updates (`pacman -Sy graphql-client-cli` or `cargo install graphql_client_cli`).
...
#### Infrastructure
- `just deploy-custom-runner` to deploy GitLab custom runner configuration
