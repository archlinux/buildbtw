...
- **Breaking Change:** Remove the `BUILDBTW_GITLAB_SSH_HOST_KEY` environment variable and associated CLI option. For deploying the backend, put the pubkey in your `.ssh/known_hosts` file instead.
