        ...
        match &self {
            ResponseError::NotAuthenticated {
                ...
                if is_browser {
                    ...
                    let login_url = format!("{}?next={}", web::oidc::StartLogin {}, encoded);
                    return (StatusCode::SEE_OTHER, [("location", login_url.as_str())])
                        .into_response();
                }
            ...
            ResponseError::NotFound(_) => (StatusCode::NOT_FOUND, self.to_string()).into_response(),
            ...
            ResponseError::AlpmPackage(_) | ResponseError::BadRequest(_) => {
                (StatusCode::BAD_REQUEST, self.to_string()).into_response()
            }
            ResponseError::NotPermitted(_) => {
                (StatusCode::FORBIDDEN, self.to_string()).into_response()
            }
            ResponseError::Conflict(_) => (StatusCode::CONFLICT, self.to_string()).into_response(),
        }
    }
}
