...
pub fn build_repo_path(
    ...
    let dest_dir =
        build_iteration_arch_dir(buildspace, iteration, build, override_data_dir)?.join("repo");
...
pub fn build_log_path(
    ...
    let dest_dir =
        build_iteration_arch_dir(buildspace, iteration, build, override_data_dir)?.join("logs");
